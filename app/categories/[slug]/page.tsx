...
import { 
  ...
  Circle, ArrowLeft, Plus, Send, User
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {/* Back Button */}
        <div className="mb-6">
          <Link href="/categories" className="flex items-center gap-2 text-gray-600 hover:text-gray-900 transition">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
              ...
              <div className="space-y-2">
                <Link href="/categories/cooking" className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 transition">
                ...
                <Link href="/categories/car-trouble" className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 transition">
