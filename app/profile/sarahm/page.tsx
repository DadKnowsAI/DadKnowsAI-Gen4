          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-2xl font-bold text-gray-900">SarahM</h1>
                <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-bold">Active</span>
              </div>
              <p className="text-gray-600 mb-4 font-bold">
                Home improvement enthusiast • DIY lover • Always learning new skills
              </p>
              <div className="flex items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  <Calendar className="w-4 h-4 text-gray-500" />
                  <span className="font-bold text-gray-700">Member since Jan 2024</span>
                </div>
                <div className="flex items-center gap-2">
