...
const TeacherTinaProfile = () => {
  ...
  const userStats = {
    ...
    location: 'Austin, TX',
    expertise: ['Parenting', 'Education', 'Child Development']
  };

  const recentPosts = [
    {
      id: '1',
      title: 'Trending in Parenting - Best bedtime routines',
      category: 'Parenting',
      nods: 289,
      comments: 45,
      time: '4 hours ago',
    ...
    {
      id: '2', 
      title: 'How to handle toddler tantrums effectively',
      category: 'Parenting',
      nods: 156,
      comments: 28,
      time: '2 days ago',
    ...
    {
      id: '3',
      title: 'Screen time guidelines for different ages',
      category: 'Education',
      nods: 203,
      comments: 31,
      time: '5 days ago',
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h1 className="text-2xl font-bold text-gray-900">TeacherTina</h1>
                    <span className="bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs font-bold">Rising Star</span>
                    <span className="bg-purple-100 text-purple-700 px-2 py-1 rounded-full text-xs font-bold">Parenting Expert</span>
                  </div>
                  <p className="text-gray-600 mb-4">Elementary school teacher and mom of three. Passionate about sharing evidence-based parenting strategies and educational tips.</p>
                        ...
                        <div className="border border-gray-200 rounded-lg p-4 hover:border-gray-300 transition cursor-pointer">
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex items-center gap-2">
                              <span className="text-xs bg-purple-100 text-purple-700 px-2 py-1 rounded font-bold">{post.category}</span>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {userStats.expertise.map((skill) => (
                  <span key={skill} className="bg-purple-100 text-purple-700 px-2 py-1 rounded text-xs font-bold">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-gray-600">Posted parenting tip</span>
                  <span className="text-gray-400">4h ago</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-600">Solved tantrum issue</span>
                  <span className="text-gray-400">2d ago</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                  <span className="text-gray-600">Gained 45 nods</span>
...
export default TeacherTinaProfile;
